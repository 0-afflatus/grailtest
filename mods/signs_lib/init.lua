...
signs_lib.construct_sign = function(pos, locked)
	...
	meta:set_string(
		...
		"background[-0.5,-0.5;7,5;bg_signs_lib.png]")
...
signs_lib.update_sign = function(pos, fields, owner)
	...
	if fields then
		...
		local ownstr = ""
		if owner then ownstr = "\n ~~ signed by "..owner.."\n" end

		meta:set_string("infotext", make_infotext(fields.text)..ownstr.." ")
...
minetest.register_node(":default:sign_wall", {
	description = S("Sign"),
	inventory_image = "equipment_sign_wall_blank_inv.png",
	wield_image = "equipment_sign_wall_blank_inv.png",
...
minetest.register_craft({
	output = "locked_sign:sign_wall_locked 4",
	recipe = {
		{"group:wood", "group:wood", "group:wood"},
