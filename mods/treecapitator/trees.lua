...
treecapitator.register_tree({
	trees = {"tree:apple_tree_trunk"},
	leaves = {"tree:apple_tree_leaves"},
	range = 2,
	fruits = {"tree:apple_fruit"}
})

treecapitator.register_tree({
	trees = {"tree:pine_tree"},
	leaves = {"tree:pine_needles"},
	range = 6,
})

treecapitator.register_tree({
	trees = {"tree:jungletree"},
	leaves = {"tree:jungleleaves"},
	range = 3
})

treecapitator.register_tree({
	trees = {"tree:acacia_tree"},
	leaves = {"tree:acacia_leaves"},
	range = 3
})

treecapitator.register_tree({
	trees = {"tree:ash_tree"},
	leaves = {"tree:ash_leaves"},
	range = 4
})

treecapitator.register_tree({
	trees = {"tree:aspen_tree"},
	leaves = {"tree:aspen_leaves"},
	range = 2
})

treecapitator.register_tree({
	trees = {"tree:banana_trunk"},
	leaves = {"tree:banana_leaves"},
	fruit = {"tree:banana"},
	range = 3
})

treecapitator.register_tree({
	trees = {"tree:beech_tree"},
	leaves = {"tree:beech_leaves"},
	range = 3
})

treecapitator.register_tree({
	trees = {"tree:birch_tree"},
	leaves = {"tree:birch_leaves"},
	range = 2
})
...
treecapitator.register_tree({
	trees = {"tree:orange_tree"},
	leaves = {"tree:orange_leaves"},
	fruit = {"tree:orange"},
	range = 3
})

treecapitator.register_tree({
	trees = {"tree:palm_tree"},
	leaves = {"tree:palm_leaves"},
	range = 3
})
