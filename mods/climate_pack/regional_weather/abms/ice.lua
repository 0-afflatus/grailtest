...
or not minetest.get_modpath("element")
or element.node_sound_glass_defaults == nil
then return end
...
minetest.register_node(BLOCK_NAME, {
	...
	tiles = {"(element_ice.png^[colorize:#ffffff:50)^[opacity:200"},
	paramtype = "light",
	groups = {
		cracky = 3,
		cools_lava = 1,
	...
	sounds = element.node_sound_glass_defaults(),
	...
	on_destruct = function(pos)
		...
		minetest.after(0, function(pos)
			...
			minetest.set_node(pos, { name = "element:river_water_source" })
		end, pos)
	end
})
...
climate_api.register_abm({
	...
	nodenames = { "element:river_water_source" },
	neighbors	= { "air" },
	interval	= 25,
	chance		= 3,
	catch_up	= false,
