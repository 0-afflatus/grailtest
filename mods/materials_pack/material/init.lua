...
-- Decorations
-- overlay texture names

material.decor_list = { "square", "cross", "arch" }
...
--[[minetest.register_node("material:glass_white", {
	...
	inventory_image = minetest.inventorycube("material_glass_white.png"),
...
minetest.register_node("material:glass_blue", {
	...
	inventory_image = minetest.inventorycube("material_glass_blue.png"),
	use_texture_alpha = true,
	paramtype = "light",
	light_source = 2,
	sunlight_propagates = true,
...
minetest.register_node("material:glass_cyan", {
	...
	inventory_image = minetest.inventorycube("material_glass_cyan.png"),
	use_texture_alpha = true,
	paramtype = "light",
	light_source = 2,
	sunlight_propagates = true,
...
minetest.register_node("material:glass_green", {
	...
	inventory_image = minetest.inventorycube("material_glass_green.png"),
	use_texture_alpha = true,
	paramtype = "light",
	light_source = 2,
	sunlight_propagates = true,
...
minetest.register_node("material:glass_yellow", {
	...
	inventory_image = minetest.inventorycube("material_glass_yellow.png"),
	use_texture_alpha = true,
	paramtype = "light",
	light_source = 2,
	sunlight_propagates = true,
...
minetest.register_node("material:glass_red", {
	...
	inventory_image = minetest.inventorycube("material_glass_red.png"),
	use_texture_alpha = true,
	paramtype = "light",
	light_source = 2,
	sunlight_propagates = true,
