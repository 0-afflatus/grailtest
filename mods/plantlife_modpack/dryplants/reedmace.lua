...
minetest.register_abm({
	...
	interval = abstract_dryplants.REEDMACE_GROWING_TIME,
	chance = 100/abstract_dryplants.REEDMACE_GROWING_CHANCE,
...
biome_lib:register_generate_plant({
    ...
    max_count = abstract_dryplants.REEDMACE_NEAR_WATER_PER_MAPBLOCK,
    rarity = 101 - abstract_dryplants.REEDMACE_NEAR_WATER_RARITY,
	--rarity = 60,
...
biome_lib:register_generate_plant({
    ...
    max_count = abstract_dryplants.REEDMACE_IN_WATER_PER_MAPBLOCK,
	rarity = 101 - abstract_dryplants.REEDMACE_IN_WATER_RARITY,
    --rarity = 35,
...
biome_lib:register_generate_plant({
    ...
    max_count = abstract_dryplants.REEDMACE_FOR_OASES_PER_MAPBLOCK,
    rarity = 101 - abstract_dryplants.REEDMACE_FOR_OASES_RARITY,
	--rarity = 10,
