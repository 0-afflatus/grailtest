...
biome_lib:register_generate_plant({
    ...
    max_count = abstract_dryplants.JUNCUS_NEAR_WATER_PER_MAPBLOCK,
    rarity = 101 - abstract_dryplants.JUNCUS_NEAR_WATER_RARITY,
...
biome_lib:register_generate_plant({
    ...
    max_count = abstract_dryplants.JUNCUS_AT_BEACH_PER_MAPBLOCK,
    rarity = 101 - abstract_dryplants.JUNCUS_AT_BEACH_RARITY,
    min_elevation = 1, -- above sea level
