...
for i in ipairs(algae_list) do
	local num = ""
	local algae_groups = {snappy = 3,flammable=2,flower=1,vegetable=1}
...
minetest.register_craftitem(":flowers:sunflower_seeds", {
	description = S("Sunflower seeds"),
	inventory_image = "flowers_sunflower_seeds.png",
	groups = {nut=1},
...
local sunflower_drop = "flowers:sunflower_seeds"
...
minetest.register_node(":flowers:sunflower", {
	...
	groups = { dig_immediate=3, flora=1, flammable=3, flower = 1 },
	sounds = default.node_sound_leaves_defaults(),
	selection_box = box,
	collision_box = box,
	drop = {
...
biome_lib:register_generate_plant({
    surface = {"default:river_water_source"},
...
biome_lib:register_generate_plant({
	...
	near_nodes_count = 3,
    plantlife_limit = -0.9,
	temp_max = -0.8, -- MM: more or less random values, just to make sure it's not everywhere
    temp_min = -0.22, -- MM: more or less random values, just to make sure it's not everywhere
  },
  flowers_plus.grow_seaweed
)
...
biome_lib:spawn_on_surfaces({
	...
	spawn_surfaces = {"default:river_water_source"},
