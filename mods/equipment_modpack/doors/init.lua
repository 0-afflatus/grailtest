...
function doors.register_door(name, def)
	...
	local function after_dig_node(pos, nname, digger)
		local node = minetest.get_node(pos)
		if node.name == nname then
			minetest.node_dig(pos, node, digger)
		end
	end

	local function check_and_blast(pos, nname)
		local node = minetest.get_node(pos)
		if node.name == nname then
...
doors.register_door("doors:door_oak", {
	description = "Oak Door",
	inventory_image = "doors_oak.png",
	groups = {snappy=1,choppy=2,oddly_breakable_by_hand=2,flammable=3,door=1},
	tiles_bottom = {"doors_oak_b.png", "doors_brown.png"},
	tiles_top = {"doors_oak_a.png", "doors_brown.png"},
	sounds = default.node_sound_wood_defaults(),
	sunlight = false,
})

minetest.register_craft({
	output = "doors:door_oak",
	recipe = {
		{"moretrees:oak_planks", "moretrees:oak_planks"},
		{"moretrees:oak_planks", "mineral:steel_ingot"},
		{"moretrees:oak_planks", "moretrees:oak_planks"}
	}
})
...
doors.register_door("doors:door_gold", {
	...
	inventory_image = "doors_gold.png",
	groups = {snappy=1,bendy=2,cracky=1,melty=2,level=2,door=1},
	tiles_bottom = {"doors_gold_b.png", "doors_gold_side.png"},
	tiles_top = {"doors_gold_a.png", "doors_gold_side.png"},
	only_placer_can_open = true,
	sounds = default.node_sound_wood_defaults(),
	sunlight = false,
})
