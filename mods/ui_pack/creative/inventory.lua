...
shape.registered_shapes = {}
shape.registered_blocks = {}

for name, node in pairs(minetest.registered_nodes) do
    if node.groups.shape then
        shape.registered_shapes[name] = node
    else
        shape.registered_blocks[name] = node
    end
end

creative.register_tab("all", S("All"), minetest.registered_items)
creative.register_tab("nodes", S("Nodes"), shape.registered_blocks)
creative.register_tab("tools", S("Tools"), registered_tools)
creative.register_tab("craftitems", S("Items"), registered_craftitems)
creative.register_tab("shapes", S("Shapes"), shape.registered_shapes)
