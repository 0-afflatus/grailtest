...
biome_lib:register_generate_plant(moretrees.orange_tree_biome, moretrees.spawn_orange_tree_object)
...
function moretrees.grow_orange(pos)
	minetest.remove_node(pos)
	minetest.spawn_tree(pos, moretrees.orange_tree_model)
end
