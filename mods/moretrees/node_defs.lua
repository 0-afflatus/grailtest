...
moretrees.treelist = {
	...
	{"pine",		"Scots Pine",		"pine_cone",	"Pine Cone",	{-0.2, -0.5, -0.2, 0.2, 0, 0.2}, 	0.8 },
	{"willow",		"Willow Tree"},
...
for color = 1, #jungleleaves do
	...
	if moretrees.plantlike_leaves then
		...
		moretrees.new_leaves_waving = 1
	end

	minetest.register_node(leave_name, {
		description = S("Jungle Tree Leaves ("..jungleleavesnames[color]..")"),
		drawtype = moretrees_new_leaves_drawtype,
		waving = moretrees.new_leaves_waving,
		visual_scale = moretrees_plantlike_leaves_visual_scale,
...
table.insert(moretrees.avoidnodes, "tree:jungletree")
table.insert(moretrees.avoidnodes, "tree:pine_tree")
table.insert(moretrees.avoidnodes, "tree:acacia_tree")
table.insert(moretrees.avoidnodes, "moretrees:fir_trunk")
table.insert(moretrees.avoidnodes, "tree:apple_tree")

if moretrees.spawn_saplings then
		table.insert(moretrees.avoidnodes, "snow:sapling_pine")
		table.insert(moretrees.avoidnodes, "tree:junglesapling")
		table.insert(moretrees.avoidnodes, "tree:pine_sapling")
		table.insert(moretrees.avoidnodes, "tree:apple_tree")
		table.insert(moretrees.avoidnodes, "tree:acacia_sapling")		
end
...
minetest.register_alias("jungletree:leaves_green",				"moretrees:jungletree_leaves")
...
minetest.register_alias("moretrees:acacia_trunk",				"tree:acacia_tree")
minetest.register_alias("moretrees:acacia_planks",				"tree:acacia_wood")
minetest.register_alias("moretrees:acacia_sapling",				"tree:acacia_sapling")
minetest.register_alias("moretrees:acacia_leaves",				"tree:acacia_leaves")

minetest.register_alias("moretrees:apple_tree_trunk",				"tree:apple_tree_trunk")
minetest.register_alias("moretrees:apple_tree_planks",				"tree:apple_tree_wood")
minetest.register_alias("moretrees:apple_tree_sapling",				"tree:apple_tree_sapling")
minetest.register_alias("moretrees:apple_tree_leaves",				"tree:apple_tree_leaves")
