...
local transparent_armor = minetest.settings:get_bool("armor_transparent", true)
...
armor = {
	...
	fire_nodes = {
		...
		{"element:lava_source",     5, 8},
		{"element:lava_flowing",    5, 8},
		{"element:basic_flame",        3, 4},
		{"element:permanent_flame",    3, 4},
		{"ethereal:crystal_spike",  2, 1},
		{"ethereal:fire_flower",    2, 1},
		{"nether:lava_crust",       2, 1},
		{"equipment:torch",           1, 1},
		{"equipment:torch_ceiling",   1, 1},
		{"equipment:torch_wall",      1, 1},
		{"equipment:bonfire",     3, 5},
	},
