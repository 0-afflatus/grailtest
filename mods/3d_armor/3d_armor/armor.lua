...
--- Ruby
--
--  Requires `armor_material_ruby`.
--
--  @section ruby

if armor.materials.ruby then
	--- Ruby Helmet
	--
	--  @helmet 3d_armor:helmet_ruby
	--  @img 3d_armor_inv_helmet_ruby.png
	--  @grp armor_head 1
	--  @grp armor_heal 12
	--  @grp armor_use 100
	--  @grp armor_fire 1
	...
	--- Ruby Chestplate
	--
	--  @chestplate 3d_armor:chestplate_ruby
	--  @img 3d_armor_inv_chestplate_ruby.png
	--  @grp armor_torso 1
	--  @grp armor_heal 12
	--  @grp armor_use 100
	--  @grp armor_fire 1
	...
	--- Ruby Leggings
	--
	--  @leggings 3d_armor:leggings_ruby
	--  @img 3d_armor_inv_leggings_ruby.png
	--  @grp armor_legs 1
	--  @grp armor_heal 12
	--  @grp armor_use 100
	--  @grp armor_fire 1
	...
	--- Ruby Boots
	--
	--  @boots 3d_armor:boots_ruby
	--  @img 3d_armor_inv_boots_ruby.png
	--  @grp armor_feet 1
	--  @grp armor_heal 12
	--  @grp armor_use 100
	--  @grp physics_speed 1
...
--  Key:
--  - m: material
--    - steel:   mineral:steel_ingot
--    - bronze:  mineral:bronze_ingot
--    - diamond: mineral:diamond_gem
--    - gold:    mineral:gold_ingot
--    - mithril: mineral:mithril_ingot
--    - ruby: mineral:ruby_gem
--
