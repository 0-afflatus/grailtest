...
minetest.register_node("tree:olive_fruit", {
	...
	inventory_image = "tree_olive.png",
	wield_image = "tree_olive.png",
	visual_scale = 0.5,
	paramtype = "light",
	sunlight_propagates = true,
	walkable = false,
...
minetest.register_node("tree:orange_fruit", {
	...
	drawtype = "plantlike",
	tiles = { "tree_orange_fruit.png" },
	inventory_image = "tree_orange_fruit.png",
	wield_image = "tree_orange_fruit.png",
	visual_scale = 0.5,
	paramtype = "light",
	sunlight_propagates = true,
	walkable = false,
