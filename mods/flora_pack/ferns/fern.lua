...
if abstract_ferns.config.lady_ferns_near_ores == true then -- this one causes a huge fps drop
	biome_lib:register_generate_plant({ -- near ores (potential mining sites)
		surface = {
			"element:dirt_with_grass",
			"element:mossycobble",
			"element:stone_with_coal",
			"element:stone_with_iron",
		...
		near_nodes = {
			"element:stone_with_iron",
			--"element:stone_with_copper",
			--"element:stone_with_mese",
			--"element:stone_with_gold",
			--"element:stone_with_diamond",
			"moreores:mineral_tin",
			"moreores:mineral_silver"
...
if abstract_ferns.config.lady_ferns_in_groups == true then -- this one is meant as a replacement of Ferns_near_Ores
	biome_lib:register_generate_plant({
		surface = {
			"element:dirt_with_grass",
			"element:mossycobble",
			"mineral:stone_with_coal",
			"mineral:stone_with_iron",
			"moreores:mineral_tin",
			"moreores:mineral_silver",
			"sumpf:sumpf"
		},
