...
if abstract_ferns.config.enable_horsetails_spawning == true then
	biome_lib:spawn_on_surfaces({
		...
		near_nodes = {"group:water","element:gravel"},
		near_nodes_size = 2,
...
if abstract_ferns.config.enable_horsetails_on_grass == true then
	biome_lib:register_generate_plant({
		...
		near_nodes = {
			...
			"element:gravel", -- near those on gravel
			"element:sand", -- some like sand
			"element:clay", -- some like clay
			"element:mossycobble",
			"element:cobble",
		},
		near_nodes_size = 3,
