...
local containers = {
	...
	{"top", "equipment:chest", "main"},
	{"bottom", "equipment:chest", "main"},
	{"side", "equipment:chest", "main"},

	{"top", "equipment:furnace", "dst"},
	{"bottom", "equipment:furnace", "src"},
	{"side", "equipment:furnace", "fuel"},

	{"top", "equipment:furnace_active", "dst"},
	{"bottom", "equipment:furnace_active", "src"},
	{"side", "equipment:furnace_active", "fuel"},

	{"bottom", "equipment:chest_locked", "main"},
	{"side", "equipment:chest_locked", "main"},

	{"top", "equipment:chest", "equipment:chest"}, --  new animated chests
	{"bottom", "equipment:chest", "equipment:chest"},
	{"side", "equipment:chest", "equipment:chest"},

	{"bottom", "equipment:chest_locked", "equipment:chest"},
	{"side", "equipment:chest_locked", "equipment:chest"},
}
...
minetest.register_craft({
	...
	recipe = {
		{"mineral:steel_ingot", "equipment:chest", "mineral:steel_ingot"},
		{"", "mineral:steel_ingot", ""},
	},
})
