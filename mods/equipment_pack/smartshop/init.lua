...
minetest.register_craft({
	...
	recipe = {
		{"material:glass_obsidian", "material:glass_obsidian", "material:glass_obsidian"},
		{"material:glass_obsidian", "equipment:chest_locked", "material:glass_obsidian"},
...
minetest.register_craft({
	...
	recipe = {
		{"mineral:mithril_ingot", "equipment:chest_locked", "mineral:mithril_ingot"},
		{"mineral:mithril_ingot", "equipment:chest_locked", "mineral:mithril_ingot"},
		{"mineral:steel_ingot", "mineral:copper_ingot", "mineral:steel_ingot"},
	}
})
]]
