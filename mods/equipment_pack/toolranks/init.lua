...
function toolranks.new_afteruse(itemstack, user, node, digparams)
  ...
  if itemstack:get_wear() > 60135 then
    ...
    minetest.sound_play("base_tool_breaks", {
      to_player = pname,
      gain = 2.0,
    })
  end
...
-- Sword
toolranks.add_tool("tool:sword_steel")
toolranks.add_tool("tool:sword_bronze")
toolranks.add_tool("tool:sword_diamond")
toolranks.add_tool("tool:sword_mithril")
toolranks.add_tool("tool:sword_ruby")
toolranks.add_tool("tool:sword_silver")

-- Pickaxe
toolranks.add_tool("tool:pick_wood")
toolranks.add_tool("tool:pick_stone")
toolranks.add_tool("tool:pick_steel")
toolranks.add_tool("tool:pick_bronze")
toolranks.add_tool("tool:pick_diamond")
toolranks.add_tool("tool:pick_mithril")
toolranks.add_tool("tool:pick_ruby")
toolranks.add_tool("tool:pick_silver")

-- Axe
toolranks.add_tool("tool:axe_wood")
toolranks.add_tool("tool:axe_stone")
toolranks.add_tool("tool:axe_steel")
toolranks.add_tool("tool:axe_bronze")
toolranks.add_tool("tool:axe_copper")
toolranks.add_tool("tool:axe_diamond")
toolranks.add_tool("tool:axe_mithril")
toolranks.add_tool("tool:axe_ruby")
toolranks.add_tool("tool:axe_silver")

-- Shovel
toolranks.add_tool("tool:shovel_wood")
toolranks.add_tool("tool:shovel_stone")
toolranks.add_tool("tool:shovel_steel")
toolranks.add_tool("tool:shovel_bronze")
--toolranks.add_tool("tool:shovel_diamond")
toolranks.add_tool("tool:shovel_gold")
toolranks.add_tool("tool:shovel_mithril")
toolranks.add_tool("tool:shovel_silver")

--[[ Staves
toolranks.add_tool("tool_staff_amethyst.png")
toolranks.add_tool("tool_staff_diamond.png")
toolranks.add_tool("tool_staff_emerald.png")
toolranks.add_tool("tool_staff_ruby.png")
toolranks.add_tool("tool_staff_topaz.png")
toolranks.add_tool("tool_staff_turquoise.png")
toolranks.add_tool("tool_staff_wood.png")
]]