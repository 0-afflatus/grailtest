...
-- Pipeworks
	...
	on_metadata_inventory_move = function(pos, from_list, from_index, to_list, to_index, count, player)
		minetest.log("action", player:get_player_name()..
				" moves stuff around in dropbox at "..minetest.pos_to_string(pos))
	end,
	on_metadata_inventory_put = function(pos, listname, index, stack, player)
		minetest.log("action", player:get_player_name()..
				" moves " .. stack:get_name() ..
				" to dropbox at "..minetest.pos_to_string(pos))
	end,
	on_metadata_inventory_take = function(pos, listname, index, stack, player)
		minetest.log("action", player:get_player_name()..
				" takes " .. stack:get_name() ..
				" from dropbox at "..minetest.pos_to_string(pos))
	end,
})
...
minetest.register_craft({
	...
	recipe = {
		{"tree:acacia_wood","tree:acacia_wood","tree:acacia_wood"},
		{"tree:acacia_wood",'mineral:steel_ingot',"tree:acacia_wood"},
		{"tree:acacia_wood","tree:acacia_wood","tree:acacia_wood"}
	}
})
