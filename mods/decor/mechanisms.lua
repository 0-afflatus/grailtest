...
function plate.register(material, desc, def)
	equipment.register("pressure_"..material.."_off", {
		description = desc.." Pressure Plate",
		tiles = {"equipment_pressure_"..material..".png"},
		drawtype = "nodebox",
		node_box = equipment.pixelbox(16, {{1, 0, 1, 14, 1, 14}}),
		groups = def.groups,
		sounds = def.sounds,
	...
	equipment.register("pressure_"..material.."_on", {
		tiles = {"equipment_pressure_"..material..".png"},
		drawtype = "nodebox",
		node_box = equipment.pixelbox(16, {{1, 0, 1, 14, 0.4, 14}}),
		groups = def.groups,
		sounds = def.sounds,
		drop = "equipment:pressure_"..material.."_off",
		sunlight_propagates = true,
		on_rotate = screwdriver.rotate_simple
	})
end
...
equipment.register("lever_off", {
	description = "Lever",
	tiles = {"equipment_lever_off.png"},
	drawtype = "nodebox",
	node_box = equipment.pixelbox(16, {{2, 1, 15, 12, 14, 1}}),
	groups = {cracky=3, oddly_breakable_by_hand=2},
	sounds = default.node_sound_stone_defaults(),
	sunlight_propagates = true,
	on_rotate = screwdriver.rotate_simple,
...
equipment.register("lever_on", {
	tiles = {"equipment_lever_on.png"},
	drawtype = "nodebox",
	node_box = equipment.pixelbox(16, {{2, 1, 15, 12, 14, 1}}),
