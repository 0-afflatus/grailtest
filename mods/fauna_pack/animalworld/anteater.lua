...
local spawn_on = {"element:dirt_with_grass_jungle"}

if minetest.get_mapgen_setting("mg_name") ~= "v6" then
	spawn_on = {"element:dirt_with_grass_jungle", "element:dirt_with_dry_grass"}
end

if minetest.get_modpath("ethereal") then
	spawn_on = {"ethereal:grass_grove", "ethereal:green_dirt", "element:dirt_with_grass_jungle"}
end
