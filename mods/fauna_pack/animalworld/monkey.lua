mobs:register_mob("animalworld:monkey", {
	...
	jump_height = 8,
	pushable = true,
	follow = {"tree:apple", "plant:potato", "ethereal:banana_bread", "plant:carrot", "plant:seed_rice", "plant:corn", "plant:wheat", "plant:beans", "plant:barley", "plant:oat", "plant:rye", "mobs:cheese", "plant:bread", "ethereal:banana_bread", "ethereal:banana", "plant:cabbage", "plant:lettuce", "plant:melon_slice", "animalworld:termitequeen", "animalworld:locust_roasted"},
	view_range = 15,
	replace_rate = 10,
...
mobs:spawn({
	...
	nodes = {"element:dirt_with_dry_grass", "element:dirt_with_grass_jungle", "tree:jungle_leaves"},
	min_light = 0,
	interval = 60,
	chance = 8000, -- 15000
