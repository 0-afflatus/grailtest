...
stepheight = 0.0,
	...
	floats = 0,
	follow = {
		"ethereal:worm", "plant:seaweed", "fishing:bait_worm",
		"plant:grass", "plant:cucumber", "plant:cabbage", "animalworld:ant", "animalworld:termite", "animalworld:fishfood"
	},
	view_range = 10,
...
mobs:spawn({
	...
	nodes = {"element:water_source"}, {"element:river_water_source"},
	min_light = 14,
	interval = 60,
	chance = 8000, -- 15000
