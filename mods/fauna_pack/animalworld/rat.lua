mobs:register_mob("animalworld:rat", {
	...
	follow = {"plant:wheat", "plant:beans", "plant:barley", "plant:oat", "plant:rye", "mobs:cheese", "plant:bread", "ethereal:banana_bread"},
	view_range = 10,

})

if minetest.get_modpath("ethereal") then
	spawn_on = {"element:stone", "element:mossycobble", "element:dirt_red"}
end

if not mobs.custom_spawn_animalworld then
mobs:spawn({
	name = "animalworld:rat",
	nodes = {"element:stone", "element:mossycobble", "element:dirt"},
	min_light = 0,
	interval = 60,
	chance = 2000, -- 15000
