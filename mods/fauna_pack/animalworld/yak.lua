mobs:register_mob("animalworld:yak", {
	...
	follow = {
		"plant:wheat", "plant:grass_1", "plant:barley",
		"plant:oat", "plant:rye", "plant:carrot", "plant:beans", "plant:lettuce"
	},
	view_range = 8,
	replace_rate = 10,
	replace_what = {
		{"group:grass", "air", 0},
		{"element:dirt_with_grass", "element:dirt", -1}
	},
--	stay_near = {"plant:straw", "group:grass"}, 10},
	fear_height = 2,
...
mobs:spawn({
	...
	nodes = {"element:dirt_with_grass", "ethereal:green_dirt", "element:dirt_with_snow", "element:permafrost"},
	min_light = 14,
	interval = 60,
	chance = 8000, -- 15000
...
minetest.register_craft({
	...
	recipe = {"animalworld:bucket_milk", "plant:salt"},
	replacements = {{ "animalworld:bucket_milk", "bucket:bucket_empty"}}
})
