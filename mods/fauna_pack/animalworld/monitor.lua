...
if minetest.get_modpath("ethereal") then
	spawn_on = {"element:desert_sand"}, {"element:desert_sandstone"}, {"element:sandstone"}, {"element:dirt_red"}, {"element:dirt_baked"}
end

if not mobs.custom_spawn_animalworld then
mobs:spawn({
	name = "animalworld:monitor",
	nodes = {"element:desert_sand"}, {"element:desert_sandstone"}, {"element:sandstone"}, {"element:dirt_red"}, {"element:dirt_baked"},
	min_light = 14,
	interval = 60,
	chance = 8000, -- 15000
	min_height = 20,
