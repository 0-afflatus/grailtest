...
fly_in = {"air"},
	floats = 0,
	follow = {"plant:dry_shrub", "plant:grass_1", "plant:dry_shrub", "plant:seed_wheat", "plant:seed_rye", "plant:junglegrass", "tree:banana", "plant:corn_cob", "plant:cabbage",
...
mobs:spawn({
	...
	nodes = {"element:dirt_with_dry_grass", "element:dirt_with_grass_light"}, 
	min_light = 0,
	interval = 60,
	chance = 8000, -- 15000
