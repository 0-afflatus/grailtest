...
stepheight = 1,
	...
	follow = {"plant:carrot", "plant:carrot_item", "plant:marram_grass_2", "plant:tomato", "plant:lettuce", "plant:cucumber", "plant:cabbage"},
	view_range = 4,
	replace_rate = 10,
	replace_what = {"plant:carrot_7", "plant:carrot_8", "plant:carrot", "plant:tomato", "plant:lettuce", "plant:cucumber", "plant:cabbage"},
	replace_with = "air",
...
local spawn_on = "element:sand"

if minetest.get_modpath("ethereal") then
	spawn_on = "element:dirt_with_grass_light"
end
