...
fly_in = {"element:water_source", "element:river_water_source", "element:water_flowing", "element:river_water_flowing"},
	floats = 0,
	follow = {
		"tree:banana", "plant:corn_cob", "plant:cabbage",
		"tree:apple", "water_life:meat_raw", "xocean:fish_edible", "ethereal:fish_raw", "ethereal:banana", "plant:cabbage", "plant:lettuce", "plant:melon_slice"
	},
...
if minetest.get_modpath("ethereal") then
	spawn_on = {"element:dirt_with_dry_grass"}, {"element:dirt_with_grass_jungle"}, {"ethereal:grove_dirt"}, {"element:dirt_with_grass_light"}
end
