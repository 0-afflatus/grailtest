mobs:register_mob("animalworld:gnu", {
	...
	jump_height = 3,
	pushable = true,
	follow = {"tree:apple", "element:dirt_with_dry_grass", "plant:seed_wheat", "plant:junglegrass", "plant:seed_oat"},
	view_range = 10,
	drops = {
...
local spawn_on = {"element:dirt_with_dry_grass"}

if minetest.get_mapgen_setting("mg_name") ~= "v6" then
	spawn_on = {"element:dirt_with_dry_grass"}
end

if minetest.get_modpath("ethereal") then
	spawn_on = {"element:dirt_with_dry_grass", "element:dirt_with_grass_light"}
end
