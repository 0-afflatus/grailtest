mobs:register_mob("animalworld:reindeer", {
	...
	jump_height = 3,
	pushable = true,
	follow = {"tree:apple", "element:dirt_with_ice", "ethereal:snowygrass", "ethereal:crystalgrass"},
	view_range = 10,
	drops = {
...
local spawn_on = {"element:dirt_with_ice", "element:dirt_with_snow"}

if minetest.get_mapgen_setting("mg_name") ~= "v6" then
	spawn_on = {"element:dirt_with_snow", "element:dirt_with_ice"}
end

if minetest.get_modpath("ethereal") then
	spawn_on = {"element:dirt_with_snow", "element:dirt_with_ice", "ethereal:crystal_dirt"}
end

if not mobs.custom_spawn_animalworld then
mobs:spawn({
	name = "animalworld:reindeer",
	nodes = {"element:dirt_with_snow", "element:dirt_with_ice", "ethereal:crystal_dirt"},
