mobs:register_mob("animalworld:notoptera", {
	...
	jump_height = 6,
	pushable = true,
	follow = {"plant:junglegrass", "plant:dry_shrub", "plant:blueberry_bush_leaves", "plant:grass", "plant:cabbage_6", "plant:lettuce_5", "plant:beetroot_5", "flowers:dandelion_yellow"},
	view_range = 5,
	drops = {
...
mobs:spawn({
	...
	nodes = {"element:permafrost", "element:dirt_with_ice"},
	min_light = 0,
	interval = 30,
	chance = 100, -- 15000
...
minetest.register_craft({
	...
	type = "shapeless",
	recipe = 
		{"animalworld:notoptera", "element:snow"}
})
