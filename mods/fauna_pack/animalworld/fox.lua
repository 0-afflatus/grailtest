mobs:register_mob("animalworld:fox", {
	...
	pushable = true,
	follow = {"tree:apple", "plant:potato", "ethereal:banana_bread", "plant:melon_slice", "plant:carrot", "plant:seed_rice", "plant:corn", "ethereal:fish_raw", "animalworld:rawfish", "mobs_fish:tropical",
...
mobs:spawn({
    ...
    nodes = {"element:permafrost", "element:dirt_with_ice", "element:permafrost_with_stones"},
