mobs:register_mob("animalworld:moose", {
	...
	jump_height = 3,
	pushable = true,
	follow = {"tree:apple", "plant:potato", "plant:melon_slice", "plant:cucumber", "plant:cabbage", "plant:lettuce", "plant:bread"},
	view_range = 10,
	drops = {
...
if minetest.get_mapgen_setting("mg_name") ~= "v6" then
	spawn_on = {"element:dirt_with_dry_grass", "element:dirt_with_dry_grass"}
end

if minetest.get_modpath("ethereal") then
	spawn_on = {"ethereal:grass_grove", "element:dirt_with_grass", "element:dirt_with_snow"}
end

if not mobs.custom_spawn_animalworld then
mobs:spawn({
	name = "animalworld:moose",
	nodes = {"element:dirt_with_snow"},
	min_light = 0,
	interval = 60,
	chance = 8000, -- 15000
	min_height = 0,
