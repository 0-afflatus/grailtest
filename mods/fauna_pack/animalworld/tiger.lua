...
if minetest.get_modpath("ethereal") then
	spawn_on = {"element:dirt_with_grass_jungle", "ethereal:green_dirt", "ethereal:grass_grove"}
end

if not mobs.custom_spawn_animalworld then
mobs:spawn({
	name = "animalworld:tiger",
	nodes = {"element:dirt_with_grass_jungle", "ethereal:green_dirt", "ethereal:grass_grove"},
	min_light = 0,
	interval = 60,
	chance = 8000, -- 15000
	min_height = 10,
