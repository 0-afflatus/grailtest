...
stepheight = 0.0,
	...
	floats = 0,
	follow = {
		"ethereal:worm", "plant:seaweed", "fishing:bait_worm", "animalworld:ant", "animalworld:termite", "animalworld:fishfood"
	},
	view_range = 1,
...
mobs:spawn({
	...
	nodes = {"element:water_source", "element:river_water_source", "element:water_flowing", "element:river_water_flowing"},
	neighbors = {"element:stone"},
	min_light = 0,
	interval = 30,
	chance = 1, -- 15000
