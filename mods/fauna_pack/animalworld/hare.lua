...
stepheight = 1,
	...
	follow = {"plant:carrot", "plant:carrot_item", "plant:grass_1", "plant:carrot_7", "plant:carrot_8", "plant:carrot", "plant:lettuce", "plant:cabbage", "ethereal:snowygrass"},
	view_range = 8,
	replace_rate = 10,
	replace_what = {"plant:carrot_7", "plant:carrot_8", "plant:carrot", "plant:lettuce", "plant:cabbage", "ethereal:snowygrass", "flowers:geranium", "flowers:rose"},
	replace_with = "air",
	...
	on_spawn = function(self)
		...
		if minetest.find_node_near(pos, 1,
				{"element:snow", "element:snowblock", "element:dirt_with_snow"}) then
			self.base_texture = {"texturehare.png"}
			self.object:set_properties({textures = self.base_texture})
		-- brown desert bunny
		elseif minetest.find_node_near(pos, 1,
				{"element:desert_sand", "element:desert_stone"}) then
			self.base_texture = {"texturehare.png"}
			self.object:set_properties({textures = self.base_texture})
		-- grey stone bunny
		elseif minetest.find_node_near(pos, 1,
				{"element:stone", "default:gravel"}) then
			self.base_texture = {"texturehare.png"}
			self.object:set_properties({textures = self.base_texture})
		end
...
local spawn_on = "element:dirt_with_grass"

if minetest.get_modpath("ethereal") then
	spawn_on = "element:dirt_with_grass_light", "element:dirt_with_grass"
end
