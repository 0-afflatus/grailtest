...
stepheight = 1,
	...
	follow = {
		"plant:seed_wheat", "plant:seed_cotton", "plant:seed_barley",
		"plant:seed_oat", "plant:seed_rye"
	},
	view_range = 10,
...
if minetest.get_modpath("ethereal") then
	spawn_on = {"ethereal:bamboo_dirt", "element:dirt_with_grass_light", "element:dirt_with_grass"}
end
