mobs:register_mob("animalworld:muskox", {
	...
	jump_height = 6,
	pushable = true,
	follow = {"default:apple", "plant:potato", "ethereal:banana_bread", "plant:melon_slice", "plant:carrot", "plant:seed_rice", "plant:corn", "ethereal:snowygrass", "ethereal:crystalgrass"},
	view_range = 6,
	replace_rate = 10,
