...
local spawn_on = {"element:dirt_with_snow"}

if minetest.get_mapgen_setting("mg_name") ~= "v6" then
	spawn_on = {"element:dirt_with_dry_grass", "element:dirt_with_snow"}
end

if minetest.get_modpath("ethereal") then
	spawn_on = {"ethereal:mushroom_dirt", "ethereal:bamboo_dirt", "ethereal:green_dirt", "ethereal:mushroom_dirt", "element:dirt_with_snow", "element:dirt_gray"}
end

if not mobs.custom_spawn_animalworld then
mobs:spawn({
	name = "animalworld:boar",
	nodes = {"element:dirt_with_snow", "element:dirt_with_grass"},
	min_light = 14,
	interval = 60,
	chance = 8000, -- 15000
