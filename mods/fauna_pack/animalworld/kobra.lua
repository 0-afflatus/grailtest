...
stepheight = 2,
	...
	fly_in = {"element:water_source", "element:river_water_source", "element:water_flowing"},
	floats = 0,
})

if minetest.get_modpath("ethereal") then
	spawn_on = {"element:desert_sandstone", "element:desert_stone", "element:sandstone", "element:dirt_with_grass_jungle", "ethereal:grove_dirt"}
end

if not mobs.custom_spawn_animalworld then
mobs:spawn({
	name = "animalworld:kobra",
	nodes = {"element:desert_sandstone", "element:desert_stone", "element:sandstone", "element:dirt_with_grass_jungle"}, 
	min_light = 0,
	interval = 60,
	chance = 8000, -- 15000
	min_height = -30,
