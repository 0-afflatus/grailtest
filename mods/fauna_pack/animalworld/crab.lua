...
stepheight = 1,
	...
	fly_in = {"element:water_source", "element:water_flowing"},
	floats = 0,
	follow = {"animalworld:rawfish", "plant:marram_grass_2"},
	view_range = 5,
	replace_rate = 10,
	replace_what = {"plant:marram_grass_2", "ethereal:fish_raw", "fishing:fish_raw", "xocean:fish_edible", "water_life:meat_raw", "mobs:clownfish_raw"},
	replace_with = "air",
