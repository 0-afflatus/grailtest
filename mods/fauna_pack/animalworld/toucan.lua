...
fly_in = {"air"},
	floats = 0,
	follow = {
		"fishing:bait:worm", "ethereal:worm", "plant:melon_slice", "plant:pineapple", "ethereal:banana", "ethereal:orange", "plant:grapes"
	},
...
if minetest.get_modpath("ethereal") then
	spawn_on = {"element:dirt_with_grass_jungle", "ethereal:grove_dirt"}
end
