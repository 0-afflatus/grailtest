...
mobs:spawn({name = "dmobs:dragon", nodes = {"group:leaves"}, neighbor = {},
	min_light = 5, max_light = 15, interval = 300, chance = 16000, active_object_count = 2, min_height = 50, max_height = 30000})

if dmobs.dragons then
	mobs:spawn({name = "dmobs:dragon1", nodes = {"element:desert_sand", "element:desert_stone"}, neighbor = {},
		min_light = 5, max_light = 15, interval = 300, chance = 24000, active_object_count = 2, min_height = 30, max_height = 30000})
	mobs:spawn({name = "dmobs:dragon2", nodes = {"element:dirt_with_dry_grass"}, neighbor = {},
		min_light = 5, max_light = 15, interval = 300, chance = 24000, active_object_count = 2, min_height = 50, max_height = 30000})
	mobs:spawn({name = "dmobs:dragon3", nodes = {"element:dirt_with_grass_jungle"}, neighbor = {},
		min_light = 0, max_light = 10, interval = 300, chance = 24000, active_object_count = 2, min_height = 30, max_height = 30000})
	...
	mobs:spawn({name = "dmobs:wyvern", nodes = {"group:leaves"}, neighbor = {},
		min_light = 0, max_light = 10, interval = 300, chance = 32000, active_object_count = 2, min_height = 30, max_height = 30000})
