...
-- local variables
	local l_spawn_in		= {"element:water_source", "element:water_flowing", "element:river_water_source", "element:river_water_flowing"}
	local l_spawn_near		= {"element:sand","element:dirt","group:seaplants","group:seacoral"}
...
-- Clownfish
	...
	mobs:spawn_specific("mobs_fish:clownfish", l_spawn_in, l_spawn_near, 5, 20, 30, l_spawn_chance, 1, -512, l_water_level)
...
-- Tropical fish
	...
	--name, nodes, neighbours, minlight, maxlight, interval, chance, active_object_count, min_height, max_height
	mobs:spawn_specific("mobs_fish:tropical", l_spawn_in, l_spawn_near, 5, 20, 30, l_spawn_chance, 1, -255, l_water_level)
