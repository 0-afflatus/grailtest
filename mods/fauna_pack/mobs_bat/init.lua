...
-- local variables
	...
	local l_spawnnear	= {"element:stone", "mineral:basalt"}
	local l_spawnchance	= 60000
	...
	mobs:spawn_specific("mobs_bat:bat", {"air"}, l_spawnnear, 0, 6, 30, l_spawnchance, 3, -1023, 255)
