...
-- default nodes
local node_fire = "element:basic_flame"
local node_permanent_flame = "element:permanent_flame"
local node_ice = "element:ice"
local node_snowblock = "element:snowblock"
local node_snow = "element:snow"
mobs.fallback_node = minetest.registered_aliases["mapgen_dirt"] or "element:dirt"
...
--	end
	...
	elseif self.lava_damage ~= 0 and nodef.groups.lava  then
		...
		effect(py, 15, "element_basic_flame.png", 1, 5, 1, 0.2, 15, true)
...
function mobs:force_capture(self, clicker)
	...
	self:mob_sound("base_place_node_hard")
