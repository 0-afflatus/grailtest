...
minetest.register_abm({
	...
	action = function(pos, node)
		...
		if under.name == "default:desert_sand" then
			minetest.set_node(pos, {name = "plant:dry_shrub"})
...
minetest.register_node("flowers:mushroom_blue", {
	description = "Blue Mushroom",
	tiles = {"flowers_mushroom_blue.png"},
	inventory_image = "flowers_mushroom_blue.png",
	wield_image = "flowers_mushroom_blue.png",
	drawtype = "plantlike",
	paramtype = "light",
	sunlight_propagates = true,
	walkable = false,
...
minetest.register_abm({
	nodenames = {"flowers:mushroom_brown", "flowers:mushroom_red", "flowers:mushroom_blue"},
	interval = 11,
	chance = 50,
	action = function(pos, node)
